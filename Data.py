...
def on_message(client, userdata, msg):
    ...
    print('pullup=',pull)
    print('situp=',sit)
    firebase.put('status',"push",push)#pushing the data to the firebase
...
def main():
    ...
    client.tls_set(ca_certs="C:/Users/Admin/Desktop/cacert.crt")#setting location for the certificate
